  ...
  def config do
    ...
    config :bonfire_fail,
      common_errors: %{
        ...
        invalid_credentials: {401, l "We couldn't find an account with the details you provided."},
        ...
        already_claimed:
          {403, l "This link or token was already used, please request a fresh one if necessary."},
